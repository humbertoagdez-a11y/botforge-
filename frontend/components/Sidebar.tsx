...
import { BarChart2, LayoutDashboard, LifeBuoy, LogOut, MessageSquare, TrendingUp, UserCircle, Zap } from 'lucide-react';
...
const NAV = [
  ...
  // "Rendimiento" y no "Reportes": el resto de la nav son sustantivos simples
  // que nombran el valor ("Conversaciones", "Estadísticas"), no el artefacto.
  // Estadísticas mide el consumo de la cuenta; Rendimiento, cómo le va al bot.
  { href: '/dashboard/reportes', label: 'Rendimiento', icon: TrendingUp },
