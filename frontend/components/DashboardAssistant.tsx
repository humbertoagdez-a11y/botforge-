    ...
    <>
      ...
      {props.withTrigger && !isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 hidden h-14 w-14 items-center justify-center rounded-full transition-transform duration-200 ease-out hover:scale-[1.08] md:flex"
          style={{
            zIndex: Z.fab,
